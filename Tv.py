...
class Tv(Tecnologia):
    ...
    def cotizar(self):
        ...
        return f"Características: Marca: {self.__marca}, Voltaje: {self.__voltaje}, Eficiencia: {self.__eficiencia}, Precio: ${self.__precio}, Tamanio: {self.__tamanio}, Descuento aplicado: {descuento_eficiencia * 100}%, Precio con descuento Eficiencia: ${precio_con_descuento}, Valor total después del descuento: ${precio_con_descuento}"
